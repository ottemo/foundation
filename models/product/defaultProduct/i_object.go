...
func (it *ProductModel) Get(attribute string) interface{} {
...
func (it *ProductModel) Set(attribute string, value interface{}) error {
	switch strings.ToLower(attribute) {
	case "_id", "id":
		it.id = value.(string)
	case "sku":
...
func (it *ProductModel) GetAttributesInfo() []models.T_AttributeInfo {
